...
rule ont_to_graph_alignment:
    ...
    output:
        ...
        ec_reads_clip = 'input/ONTEC/{sample}_ONTEC_{readset}_MAP-TO_{graph_reads}_{graph_readset}.MBG-k{kmer}-w{window}.fasta.gz',
        ec_reads_full = 'input/ONTHY/{sample}_ONTHY_{readset}_MAP-TO_{graph_reads}_{graph_readset}.MBG-k{kmer}-w{window}.fasta.gz'
    log:
